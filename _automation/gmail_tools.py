...
class GmailTools:
    ...
    def __init__(self, auth_manager):
        ...
        self.skip_senders = [
            ...
            # OneDrive/Microsoft 365 system notifications
            'microsoft.com', 'onedrive', 'sharepoint', 'office365.com',
            'microsoft-noreply.com', 'msft-noreply'
        ]
        ...
        self.skip_keywords = [
            ...
            # Sign-ups and registrations (promotional)
            'sign up', 'signup', 'register now', 'create account',
            'join us', 'confirm your email', 'verify email'
        ]
