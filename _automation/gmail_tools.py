...
class GmailTools:
    ...
    def __init__(self, auth_manager):
        ...
        self.skip_senders = [
            ...
            # Cloud storage/update notifications
            'onedrive'
        ]
        ...
        self.skip_keywords = [
            ...
            # Sign-up/registration confirmations and reminders
            'sign up', 'signup', 'registration confirmation',
            'welcome to', 'account created', 'thanks for signing up'
        ]
