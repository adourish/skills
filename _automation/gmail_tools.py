...
class GmailTools:
    ...
    def __init__(self, auth_manager):
        ...
        self.skip_senders = [
            ...
            # OneDrive / SharePoint file-activity notifications
            'onedrive.com',
            'sharepoint.com',
            'email.microsoft.com',
