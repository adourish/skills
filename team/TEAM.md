...
```
Read tools/skills/team/<folder>/SKILL.md and act as <AgentName> to complete this task: <task description>
```

Example:
```
Read tools/skills/team/louie/SKILL.md and act as LOUIE to write a test class for cmn_BatchManagementService.cls covering the scheduleBatch and cancelBatch methods.
```
